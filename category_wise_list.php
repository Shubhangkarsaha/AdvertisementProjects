    ...
    <tr align="center" >
      <td height="36" colspan="12">
        <table width="100%" border="0" cellspacing="1" cellpadding="1">
          <tr>
		  <form name="export" id="export" method="post" action="export_category_wise_list.php">
		  	<input type="hidden" name="category" id="category" value="<?php echo $category;?>" />
		  </form>
		  <form name="print" id="print" method="post" action="print_category_wise_list.php" target="_blank">
		  	<input type="hidden" name="category" id="category" value="<?php echo $category;?>" />
		  </form>
