...
<h1>
       Category Wise Report <small>&nbsp;</small>      </h1>
      
      </section>
<br>
<form id="form1" name="form1" method="post" action="category_wise_list.php" enctype="multipart/form-data">
  <table width="80%" border="0" align="center" cellpadding="1" cellspacing="1">
    ...
    <tr>
      ...
      <td width="14%" height="32" align="right"><strong>Category </strong></td>
