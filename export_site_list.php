...
if(isset($_GET['active']))
  {
    $sql = "select * from site_details_master where site_status = '0' order by site_id desc";
  }
 else
 {
    $sql = "select * from site_details_master order by site_id desc";  
  }	
	$rec = q($sql);
//$SI = $_GET['scheme_id'];
...
header('Content-Disposition: attachment;filename="Site Details.xlsx"');
