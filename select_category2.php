...
<form action="category_rate_master.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
          <table width="61%" border="0" align="center" cellpadding="1" cellspacing="1" class="main_bod" >
            ...
            <tr class="fnt">
              <td width="48%" height="39" align="right">Category</td>
              <td width="2%" height="39" align="center">:</td>
              <td width="50%" height="39" align="left"><select name="category" id="category" required="">
			  ...
			  <?php
			   ...
			   while($res = f($rec))
			    {
				?>
				<option value="<?php echo @$res['cat_id'];?>" <?php if(isset($_GET['Edit'])) if($fres['pay_category'] == $res['cat_id']){echo "selected";}?>><?php echo $res['cat_name'];?></option>
				<?php 
				 }
				?>
			  </select></td>
