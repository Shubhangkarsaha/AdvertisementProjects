...
<h1>
       Category &amp; Company Wise Report <small>&nbsp;</small>      </h1>
      
      </section>
<br>
<form id="form1" name="form1" method="post" action="cat_and_com_wise_list.php" enctype="multipart/form-data">
  <table width="75%" border="0" align="center" cellpadding="1" cellspacing="1" class="main_bod">
    <tr>
    ...
    <tr>
      ...
      <td width="17%" align="left"><strong>
        <select name="category" id="category" required="">
          ...
          <?php
			$sql = "select * from category_master where cat_status = '0' order by cat_name asc";
			$rec = q($sql);
			while($res = f($rec))
			{
		?>
      ...
      <td width="14%" height="32" align="right">&nbsp;</td>
